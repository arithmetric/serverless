...
usage: serverless resources deploy`,
    ...
    /**
     * Monitor CF Stack Status (Create/Update/Delete)
     * moved from lib/utils/aws/CloudFormation.js
     */
    ...
    _monitorCf(cfData, checkFreq) {
      ...
      let validStatuses = ['CREATE_COMPLETE', 'CREATE_IN_PROGRESS', 'DELETE_COMPLETE', 'DELETE_IN_PROGRESS', 'UPDATE_COMPLETE', 'UPDATE_IN_PROGRESS', 'UPDATE_COMPLETE_CLEANUP_IN_PROGRESS'];
      ...
      return new BbPromise(function(resolve, reject) {
        ...
        async.whilst(
            function() {
              return (stackStatus !== 'UPDATE_COMPLETE' && stackStatus !== 'DELETE_COMPLETE' && stackStatus !== 'CREATE_COMPLETE');
            },
